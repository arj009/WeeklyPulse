...
RATING_KEYS = ("star_rating", "rating", "stars")
TITLE_KEYS = ("review_title", "title")
TEXT_KEYS = ("review_text", "review", "text", "body")


def detect(fieldnames: list[str]) -> bool:
    h = {x.lower() for x in fieldnames}
    return "package name" in h or "review link" in h or "device" in h and "star rating" in h
